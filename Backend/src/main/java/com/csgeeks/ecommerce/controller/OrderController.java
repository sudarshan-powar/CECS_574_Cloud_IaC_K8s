...
import com.csgeeks.ecommerce.dto.checkout.CheckoutItemDto;
import com.csgeeks.ecommerce.dto.checkout.StripeResponse;
import com.csgeeks.ecommerce.exceptions.AuthenticationFailException;
import com.csgeeks.ecommerce.exceptions.OrderNotFoundException;
...
import com.csgeeks.ecommerce.service.OrderService;
...
//        SessionCreateParams sessionParams = orderService.createSession(checkoutItemDtoList);
//    	Session session = Session.create(sessionParams);
//        System.out.println("here session after create");
//
//        
//        StripeResponse stripeResponse = new StripeResponse(session.getId());
//        // send the stripe session id in response
